...
export class PoemWikiToken__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class PoemWikiToken extends ethereum.SmartContract {
  static bind(address: Address): PoemWikiToken {
    return new PoemWikiToken("PoemWikiToken", address);
  }
  ...
  batchTransferFrom(
    ...
    let result = super.call(
      "batchTransferFrom",
      "batchTransferFrom(address,address[],uint256[]):(bool)",
      [
...
export class BatchMintCall__Inputs {
  ...
  get toArray(): Array<Address> {
    return this._call.inputValues[0].value.toAddressArray();
  }

  get amountArray(): Array<BigInt> {
...
export class MintAndApproveCall extends ethereum.Call {
  get inputs(): MintAndApproveCall__Inputs {
    return new MintAndApproveCall__Inputs(this);
  }

  get outputs(): MintAndApproveCall__Outputs {
    return new MintAndApproveCall__Outputs(this);
  }
}

export class MintAndApproveCall__Inputs {
  _call: MintAndApproveCall;

  constructor(call: MintAndApproveCall) {
    this._call = call;
  }
...
export class MintAndApproveCall__Outputs {
  _call: MintAndApproveCall;
